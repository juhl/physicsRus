DemoWeb = function() {
	...
	function init(s) { 
		...
		var body1 = new Body(Body.DYNAMIC, -70, 450);
		...
		var body2 = new Body(Body.DYNAMIC, -70, 310);
		var shape = new ShapeBox(0, 0, 20, 20);
		shape.e = 0.0;
		shape.u = 1.0;
		shape.density = 1;
		...
		var body3 = new Body(Body.DYNAMIC, 70, 450);
		var shape = new ShapeBox(0, 0, 20, 20);
		shape.e = 0.0;
		shape.u = 1.0;
		shape.density = 1;
		...
		var body4 = new Body(Body.DYNAMIC, 70, 310);
		var shape = new ShapeBox(0, 0, 20, 20);
		shape.e = 0.0;
		shape.u = 1.0;
		shape.density = 1;
		...
		var joint7 = new DistanceJoint(body2, body4, new vec2(-60, 310), new vec2(60, 310));
		joint7.setSpringCoeffs(2, 0.1);
		space.addJoint(joint7);
	}
