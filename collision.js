var Collision = function() {
    ...
    function addColFunc(a, b, func) {
        colFuncs[a * Shape.NUM_TYPES + b] = func;
    }

    return {
        init : function() {
            addColFunc(Shape.TYPE_CIRCLE, Shape.TYPE_CIRCLE, circle2Circle);
            addColFunc(Shape.TYPE_CIRCLE, Shape.TYPE_SEGMENT, circle2Segment);
            addColFunc(Shape.TYPE_CIRCLE, Shape.TYPE_POLY, circle2Poly);
            addColFunc(Shape.TYPE_SEGMENT, Shape.TYPE_SEGMENT, segment2Segment);
            addColFunc(Shape.TYPE_SEGMENT, Shape.TYPE_POLY, segment2Poly);
            addColFunc(Shape.TYPE_POLY, Shape.TYPE_POLY, poly2Poly);
        },
        collide : function(a, b, contactArr) {
            if (a.type > b.type) {
                var c = a;
                a = b;
                b = c;
