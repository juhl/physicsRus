...
RopeJoint.prototype.initSolver = function(dt, warmStarting) {
	...
	// Check limit state of max distance
	var c = this.distance - this.restLength;
	if (c > 0) {
...
RopeJoint.prototype.solveVelocityConstraints = function() {
    ...
    var cdot = this.u.dot(vec2.sub(body2.v, body1.v)) + this.s2 * body2.w - this.s1 * body1.w + this.cdt;	
